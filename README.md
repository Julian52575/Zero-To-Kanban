...
request** — it explains the full ADR → issue → branch → PR → release chain, the
CI/CD gates, and the label taxonomy, with diagrams.

## Project documentation

| Document | What it covers |
| -------- | -------------- |
| [`CONTRIBUTING.md`](CONTRIBUTING.md) | Governance chain, CI/CD workflow, branch/commit rules, labels, release process |
| [`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md) | Expected behaviour and enforcement for everyone taking part |
| [`CHANGELOG.md`](CHANGELOG.md) | Release history — generated by `release-please`, do not edit by hand |
| [`SCORECARD.md`](SCORECARD.md) | Latest [OpenSSF Scorecard](https://securityscorecards.dev/) results and remediation notes |
| [Architecture Decision Records](https://github.com/Julian52575/Zero-To-Kanban/discussions/categories/architecture-decision-records?discussions_q=) | Every architectural decision, discussed and recorded (mirrored into `docs/adr/` once accepted) |
| [Security advisories](https://github.com/Julian52575/Zero-To-Kanban/security/advisories/new) | Report a vulnerability privately — never as a public issue |
